        ...
        <div className='overflow-hidden'>
            ...
            <div className='flex justify-between flex-col md:flex-row'>
                <Link to="/fragrance" className='w-full'>
                    <div className='relative w-full flex justify-center items-center h-80 xl:h-140 bg-black cursor-pointer overflow-hidden'>
                        <img className='w-full h-full object-cover hover:opacity-60 hover:scale-125 duration-500' src='https://s3-alpha-sig.figma.com/img/f22a/2543/45e5df9ac65f5d27af827080dd784483?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=QeeLifgTEB43xFEZ3Jb~YGHW-iK7aY7TqoG7kdTl6Y9QPl1GngOLloRUz--FtRx8GP~OByKMojEuv54UPE9Sz~-Ej5UdG~7UfluYPhhGN9ps~tTjtV~NqMSyXlGMbZskBTOv7CMPxACdeU7EuF0Bp~CUgmN1X3S~V-Wc2G1RCIH7AxzwAGp7YxvZOoAdQmMqPrlIQez~61QC0XOeRLMR8wdtGPOf-m0ZivBfiwgJ840~fxA362mmGxIbasNwq-BsuPnugH3itCLxAbBw7jte7Uv2UKzQZpdJwJZS0n3lKI98Yg3V4Qb2dCzBj9dNYE3lTHo-3-u6i5HSszop6OAMyw__'/>
